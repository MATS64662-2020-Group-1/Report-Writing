...
The FEM is used to simulation of heat diffusion, displacement and stress distribution in a binary image of a globular Ti-6Al-4V microstructure \ref{fig:FinalSimulationInput}.
\\
\begin{figure}[h!]
    \centering
    \includegraphics[width=13cm]{Ti64_Final_Simulation.png}
    \caption{Input image of globular Ti-6Al-4V for the FEM simulation}
